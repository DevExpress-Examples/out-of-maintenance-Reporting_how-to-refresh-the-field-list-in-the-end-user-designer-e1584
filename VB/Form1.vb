...
Namespace FieldList_UpdateDataSource
    Partial Public Class Form1
        ...
        Private Sub commandBarItem46_ItemClick(ByVal sender As Object, ByVal e As ItemClickEventArgs) _
        Handles commandBarItem46.ItemClick
            BindReportToData()
        End Sub
...
#Region "#UpdateFieldList"
        Private Sub BindReportToData()
            ...
            Dim fieldList As FieldListDockPanel = _
                CType(xrDesignDockManager1(DesignDockPanelType.FieldList), FieldListDockPanel)
            Dim host As IDesignerHost = _
                CType(xrDesignPanel1.GetService(GetType(IDesignerHost)), IDesignerHost)
